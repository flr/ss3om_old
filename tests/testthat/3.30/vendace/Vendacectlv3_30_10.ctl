...
#C control file for a KAtegatt (1fleet 5 surveys)
#_data_and_control_files: Vendace.dat // Vendace.ctl
#V3.30.10.00-trans;_2018_01_09;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_11.6
...
#_	LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env_var&link	dev_link	dev_minyr	dev_maxyr	dev_PH	Block	Block_Fxn		
	0.1	2.4	0.283	0.2	0.8	0	-1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1_0.5
	0.1	2.4	0.234	0.2	0.8	0	-1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1_1.5
	0.1	2.4	0.202	0.2	0.8	0	-1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1_5.5
	0.1	2.4	0.2	0.2	0.8	0	-1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1_10.5
	0.1	2.4	0.4	0.2	0.8	0	-1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1_11.5

	0	20	10	4	10	0	-2	0	0	0	0	0	0	0	#	L_at_Amin_Fem_GP_1
	10	40	16.31	16.31	10	0	-4	0	0	0	0	0	0	0	#	L_at_Amax_Fem_GP_1
	0.05	0.8	0.47	0.47	0.8	0	-4	0	0	0	0	0	0	0	#	VonBert_K_Fem_GP_1
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
         9.505        40.555         11.03        12.545             2             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.1             1         0.99           0.8          0.28             0          -2          0          0          0          0          0          0          0 # SR_BH_steep
...
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
 ...
 0.001 1 0.2 0.1 0.1 0 1 # InitF_seas_1_flt_2Seals
#2018 2036
# F rates by fleet
...
#         3         1         0         1         0         1  #  CPUE
         3         1         0         1         0         1  #  Acoustic1
-9999 0 0 0 0 0
#
#_Q_parms(if_any);Qunits_are_ln(q)
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
#          -25            25      -2.47811             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_CPUE(2)
#            0             1           0.1           0.1           0.1             0          3          0          0          0          0          0          0          0  #  Q_extraSD_CPUE(2)
           -25            25       3.86604             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_Acoustic1(3)
             0             1           0.1           0.1           0.1             0         -3          0          0          0          0          0          0          0  #  Q_extraSD_Acoustic1(3)
...
#_Pattern Discard Male Special
 ...
 12 0 0 0 # 2 Fleet
# 12 0 0 0 # 3 CPUE
 12 0 0 0 # 4 Acoustic1

#Selectivity ages??
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
             0           7.6          1.26            -2           0.1             0          1          0          0       0       0         0         0          0  #  AgeSel_P1_Fleet(1)
             0           7.4           1.3             0           0.1             0          3          0          0       0       0         0          0          0  #  AgeSel_P2_Fleet(1)
             0           7.6          1.26            -2           0.1             0          1          0          0       0       0         0          0          0  #  AgeSel_P1_Seals(2)
             0           7.4           1.3             0           0.1             0          3          0          0       0       0         0          0          0  #  AgeSel_P2_Seals(2)
#             0           7.6          1.26            -2           0.1             0          1          0          0          0          0          0          0          0  #  AgeSel_P1_CPUE(3)
#             0           7.4           1.3             0           0.1             0          3          0          0          0          0          0          0          0  #  AgeSel_P2_CPUE(3)
             0           7.6          1.26            -2           0.1             0          1          0          0          0          0          0          0          0  #  AgeSel_P1_Acoustic1(4)
             0           7.4           1.3             0           0.1             0          3          0          0          0          0          0          0          0  #  AgeSel_P2_Acoustic1(4)
