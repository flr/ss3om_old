...
2029 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs
...
1 8 #_min and max age over which average F will be calculated with F_reporting=4 or 5
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1591354668
