...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
            16            25         18.03        12.545             2             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.1             1          0.66          0.74          0.113            2          2          0          0          0          0          0          0          0 # SR_BH_steep
...
-17 #_recdev_early_start (0=none; neg value makes relative to recdev_start)
 2 #_recdev_early_phase #MB why 4?  default -4 
-1 #_forecast_recruitment phase (incl. late recr) (0 value resets to maxphase+1)
 1 #_lambda for Fcast_recr_like occurring before endyr+1
 1956.0   #_last_early_yr_nobias_adj_in_MPD 
1974.7   #_first_yr_fullbias_adj_in_MPD 
2016.9   #_last_yr_fullbias_adj_in_MPD 
2017.4   #_first_recent_yr_nobias_adj_in_MPD 
0.9649   #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models) (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
           -25            25      -2.47811             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_Acoustic(2)
             0             1           0.001           0.1           0.1             0         -3          0          0          0          0          0          0          0  #  Q_extraSD_Acoustic(2)
           -25            25       3.86604             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_Trapnet(3)
             0             1           0.001           0.1           0.1             0         -3          0          0          0          0          0          0          0  #  Q_extraSD_Trapnet(3)
...
#_Pattern Discard Male Special
 ...
 17 0 0 0 # 3 Trapnet
  ...
  -1	1 	 0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Reference age
  -25	25 	 15 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 1
  -5 	9 	 1.45 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 2
  -5 	9 	 0.4 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 3
  -5 	9 	 0.15 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 4
  -5 	9 	 0.14 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 5
  -5 	9 	 0.03 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 6
 ...
 -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 20
  ...
  -5 	9 	 0.2 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 3
  -5 	9 	 0.02 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 4
  -5 	9 	 0.11 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 5
  -5 	9 	 0.14 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 6
 ...
 -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 20
  ...
  -1	1 	 0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Reference age
  -25	25 	 15 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 1
  -5 	9 	 2.8 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 2
  -5 	15 	 15 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 3
...
# 0.0001  20     5      0.02      0.5     0        -5            # PEAK	value_NET_TUN_dev_se
#-0.99    0.99   0.00   0.89      0.5     0        -6            # PEAK	value_NET_TUN_dev_autocorr
