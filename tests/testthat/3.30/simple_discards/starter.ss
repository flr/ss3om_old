...
2011 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs
...
1 # F_std_basis: 0=raw_annual_F; 1=F/Fspr; 2=F/Fmsy ; 3=F/Fbtgt; where F means annual_F
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1585084023
